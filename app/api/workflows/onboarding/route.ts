    ...
    if (state === 'non-active') {
      await context.run('send-email-non-active', async () => {
        await sendEmail({
          ...
          message: `Hey ${fullName}, we haven't seen you in a while. Are you still interested in our platform?`,
        })
      })
      ...
      await context.run('send-email-active', async () => {
        await sendEmail({
          ...
          message: `Hey ${fullName}, thanks for being active on our platform!`,
        })
      })
    }
